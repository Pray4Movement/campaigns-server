<template>
  <div class="day-overview-page">
    ...
    <div class="breadcrumb">
      <NuxtLink :to="`/admin/campaigns/${campaignId}`" class="breadcrumb-link">Campaign</NuxtLink>
      <span class="breadcrumb-separator">›</span>
      <NuxtLink :to="`/admin/campaigns/${campaignId}/content`" class="breadcrumb-link">
        Content Libraries
      </NuxtLink>
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-link">{{ library?.name || 'Library' }}</span>
      <span class="breadcrumb-separator">›</span>
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <div class="header-actions">
          <UButton
            :to="`/admin/campaigns/${campaignId}/content`"
            variant="outline"
            size="sm"
          >
            Back to Calendar
      ...
      <div class="languages-table">
        ...
        >
          ...
          <div class="col-actions">
            <template v-if="lang.translation">
              <UButton
                :to="`/admin/campaigns/${campaignId}/libraries/${libraryId}/days/${dayNumber}/content/${lang.translation.id}`"
                variant="link"
                size="sm"
              >
                Edit
