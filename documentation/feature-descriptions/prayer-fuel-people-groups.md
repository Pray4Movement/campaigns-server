...
This lets campaigns include people group information without manually creating content for each one.

## The Two Virtual Libraries

### People Group (Campaign's Linked Group)

Each campaign can be linked to a specific people group. When this virtual library is added to the prayer fuel order, it displays that campaign's linked people group every day.

For example, if a campaign is focused on praying for the Berber people of Morocco, adding this library shows the Berber people group card on every day's prayer fuel.

This is useful for campaigns dedicated to a single people group, keeping the focus consistent.
...
**Different for each campaign** - Each campaign sees a different people group on the same day. This spreads prayer coverage across all people groups rather than everyone praying for the same one.
...
**No duplicates within a campaign** - The daily people group is always different from the campaign's linked people group (they're offset in the rotation).

When displayed, this library shows a "People Group of the Day" title above the people group card to distinguish it from the campaign's main people group.
...
- Add just the campaign's people group for focused campaigns
- Add just the daily rotating people group for variety
- Add both to show the campaign's focus group plus introduce subscribers to other unreached peoples
...
1. Take the current day number (days since the campaign start date)
2. Add an offset based on the campaign's linked people group
3. Find the people group at that position in the shuffled order

Because each campaign has a different offset (based on their linked people group), different campaigns see different people groups on the same day.

## Design Decisions

**Offset by campaign's people group** - Using the campaign's linked people group as an offset ensures natural distribution. Campaigns focused on different regions will see different daily people groups.
...
**"People Group of the Day" title** - The daily group shows this title to distinguish it from the campaign's main people group. Without this, seeing two people group cards could be confusing.
